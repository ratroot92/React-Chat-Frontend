...
<form class="form-horizontal form-label-left" method="POST" action="{{url('/admin/addSubCategories')}}"  enctype="multipart/form-data" id="addcategory_form" name="addcategory_form" >
 @csrf
 ...
 <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="name" name="name" required="required" class="form-control col-md-7 col-xs-12"  pattern="[/^[a-zA-Z\. ]*$/]{3,30}">
                        </div>
                        @if ($errors->has('name'))
                      <div style="color:red;">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Parent Category Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                       <select name="category" id="category" class=" col-md-6 col-sm-6 col-xs-12 form-control " required>
                      ...
                      <div style="color:red;">
                        ...
                        <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Sub Category Image <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Sub Category Status <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
