                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> Categories <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{url('/admin/add_store')}}">Add Categories</a></li>
                                    <li><a href="{{url('/admin/stores')}}">Edit Categories</a></li>
                                </ul>

                            </li>

                            <li><a><i class="fa fa-edit"></i> Sub Categories <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{url('/admin/sub_category')}}">Add Sub Categories</a></li>
                                    <li><a href="{{url('/admin/subcategories')}}">Edit Sub Categories</a></li>
                                </ul>
